...
def translate(text):
    translations = {
        ...
        "Selamat Datang di Dashboard Analisis Klaster Terminal": {"Indonesia": "Selamat Datang di Dashboard Analisis Klaster Terminal", "English": "Welcome to Terminal Cluster Analysis Dashboard"},
